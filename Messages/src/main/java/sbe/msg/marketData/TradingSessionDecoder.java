...
public class TradingSessionDecoder
{
    ...
    private final TradingSessionDecoder parentMessage = this;
    ...
    public TradingSessionDecoder wrap(
    ...
    {
        return TradingSessionEnum.get(CodecUtil.uint8Get(buffer, offset + 0));
    }
