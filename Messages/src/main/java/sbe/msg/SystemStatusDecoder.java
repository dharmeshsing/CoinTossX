...
public class SystemStatusDecoder
{
    ...
    private final SystemStatusDecoder parentMessage = this;
    ...
    public SystemStatusDecoder wrap(
    ...
    {
        return SystemStatusEnum.get(CodecUtil.uint8Get(buffer, offset + 0));
    }
